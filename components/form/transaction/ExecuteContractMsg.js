...
const ExecuteContractMsgForm = ({ address, chain, style, msgs, setMsgs }) => {
    ...
    const handleInputJson = (str) => {
        try{
            ...
            openNotification('error', 'Fail to parse JSON string: ' + e.message)
        }
    }
...
export default ExecuteContractMsgForm